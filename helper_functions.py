...
def forward_step(
    ...
    # alpha_{i-1} = alpha_prod_t_prev**0.5 
    # alpha_{i} = alpha_prod_t**0.5 
    # sample is z_i
    # model_output is epsilon
    # sigma_{i-1}  =  ((1 - alpha_prod_t_prev)**0.5) 
    # sigma_i = (beta_prod_t ** 0.5) or ((1 - alpha_prod_t)**0.5)
    #print(sample)
...
def reverse_step(
    ...
    # we go from t_prev to t. That is, we compute z_t given z_{t_prev} at t_prev
    # alpha_{t_prev} = alpha_prod_t_prev**0.5 
    # alpha_{t} = alpha_prod_t**0.5 
    # sample is z_{t_prev}
    # model_output is epsilon at t_prev
    # sigma_{t_prev}  =  ((1 - alpha_prod_t_prev)**0.5) 
    # sigma_t = (beta_prod_t ** 0.5) or ((1 - alpha_prod_t)**0.5)
...
# Using SD 1.4
#model_path_diffusion = "CompVis/stable-diffusion-v1-4/tree/main/unet"
